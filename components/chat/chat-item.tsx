            ...
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    <div className="flex items-center gap-x-2">
                        ...
                        <span className="text-xs text-zinc-500 dark:tex-zinc-400">
                            {timestamp}
                        </span>
                    </div>
                    {isImage && (
                    ...
                    {!fileUrl && isEditing && (
                        <Form {...form}>
                            ...
                            <span className="text-[10px] mt-1 text-zinc-400">
                                Press <span className="text-indigo-400">escape</span> to cancel, or <span className="text-indigo-400">enter</span> to save
                            </span>
                        </Form>
                    )}
                </div>
